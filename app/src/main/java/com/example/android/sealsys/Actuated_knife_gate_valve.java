...
public class Actuated_knife_gate_valve extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_actuated_knife_gate_valve);
        ...
        item.add(new listView("Single Acting:","Air to Close Spring to Open\n" +
                "Fail Safe : Fail to Close"));
